    ...
    return (
      <div className="min-h-screen bg-[var(--background)] p-4 sm:p-8">
        <div className="mx-auto flex max-w-2xl flex-col items-center justify-center px-5 py-20 text-center">
          ...
          <h2 className="mb-2 text-xl font-extrabold text-[#0A1628]">2FA Enabled</h2>
      ...
      <div className="min-h-screen bg-[var(--background)] p-4 sm:p-8">
        <div className="mx-auto max-w-2xl space-y-6">
          ...
          <div className="mb-6 text-center">
            ...
            <h2 className="mb-1.5 text-lg font-extrabold text-[#0A1628]">Enter Verification Code</h2>
          ...
          <div className="mb-6 flex justify-center gap-2">
            {otp.map((digit, i) => (
              <input
                ...
                className="h-14 w-12 rounded-xl border-[1.5px] border-[#F1F5F9] bg-[#F8FAFC] text-center text-xl font-bold text-[#0A1628] outline-none transition focus:border-[#2563EB] focus:bg-white focus:ring-2 focus:ring-[rgba(37,99,235,0.12)]"
              />
            ))}
          </div>

          <div className="mb-7 text-center">
            <span className="text-[0.8rem] text-[#94A3B8]">Didn&apos;t receive a code? </span>
    ...
    <div className="min-h-screen bg-[var(--background)] p-4 sm:p-8">
      <div className="mx-auto max-w-2xl space-y-5">
        ...
        <div className="mb-2 text-center">
          ...
          <h2 className="mb-1.5 text-xl font-extrabold text-[#0A1628]">Add Extra Security</h2>
          <p className="text-[0.82rem] leading-relaxed text-[#94A3B8]">
        ...
        <button
          ...
          className={`flex w-full items-center gap-3.5 rounded-2xl border-[1.5px] p-4 text-left transition ${
            method === 'sms' ? 'border-[#2563EB] bg-[#EFF4FF]' : 'border-[#F1F5F9] bg-white hover:border-[#E2E8F0]'
          }`}
        >
          ...
          <div className="flex-1">
            <div className="text-[0.88rem] font-bold text-[#0A1628]">Text Message (SMS)</div>
            <div className="text-[0.75rem] text-[#94A3B8]">Get a code sent to your phone</div>
          </div>
          <div className={`flex h-[22px] w-[22px] items-center justify-center rounded-full border-2 ${method === 'sms' ? 'border-[#2563EB] bg-[#2563EB]' : 'border-[#E2E8F0]'}`}>
        ...
        <button
          ...
          className={`flex w-full items-center gap-3.5 rounded-2xl border-[1.5px] p-4 text-left transition ${
            method === 'auth' ? 'border-[#2563EB] bg-[#EFF4FF]' : 'border-[#F1F5F9] bg-white hover:border-[#E2E8F0]'
          }`}
        >
          ...
          <div className="flex-1">
            <div className="text-[0.88rem] font-bold text-[#0A1628]">Authenticator App</div>
            <div className="text-[0.75rem] text-[#94A3B8]">Use Google or Microsoft Authenticator</div>
          </div>
          <div className={`flex h-[22px] w-[22px] items-center justify-center rounded-full border-2 ${method === 'auth' ? 'border-[#2563EB] bg-[#2563EB]' : 'border-[#E2E8F0]'}`}>
        ...
        {method === 'sms' && (
          <div>
            <label className="mb-1.5 block text-xs font-semibold uppercase tracking-wider text-[#94A3B8]">Phone Number</label>
            <input
              type="tel"
        ...
        {method === 'auth' && (
          <div className="text-center">
            <p className="mb-4 text-[0.82rem] leading-relaxed text-[#64748B]">Scan this QR code with your authenticator app</p>
            <div className="mx-auto flex h-40 w-40 flex-col items-center justify-center gap-2 rounded-2xl border-2 border-dashed border-[#E2E8F0] bg-[#F8FAFC]">
              <svg className="h-16 w-16 text-[#CBD5E1]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 4.875c0-.621.504-1.125 1.125-1.125h4.5c.621 0 1.125.504 1.125 1.125v4.5c0 .621-.504 1.125-1.125 1.125h-4.5A1.125 1.125 0 013.75 9.375v-4.5zM3.75 14.625c0-.621.504-1.125 1.125-1.125h4.5c.621 0 1.125.504 1.125 1.125v4.5c0 .621-.504 1.125-1.125 1.125h-4.5a1.125 1.125 0 01-1.125-1.125v-4.5zM13.5 4.875c0-.621.504-1.125 1.125-1.125h4.5c.621 0 1.125.504 1.125 1.125v4.5c0 .621-.504 1.125-1.125 1.125h-4.5A1.125 1.125 0 0113.5 9.375v-4.5z" />
              </svg>
              <span className="text-[0.68rem] font-medium text-[#CBD5E1]">QR Code</span>
            </div>
            <div className="mt-3 inline-block rounded-[10px] bg-[#F8FAFC] px-3.5 py-2">
              <span className="text-[0.72rem] font-medium text-[#94A3B8]">Or enter: </span>
              <span className="font-mono text-[0.72rem] font-bold text-[#0A1628]">BTAX-XKCD-7J2F-9RWQ</span>
            </div>
          </div>
        )}
