    ...
    <div className="min-h-screen" style={{ background: '#FAFAFF' }}>
      <div className="mx-auto max-w-lg lg:max-w-3xl">
        ...
        <div style={{ display: 'flex', alignItems: 'center', padding: '14px 20px 12px' }}>
          <button
            onClick={() => router.back()}
            style={{ color: '#1A1A2E', background: 'none', border: 'none', cursor: 'pointer', padding: 0 }}
          >
            <i className="fas fa-arrow-left" style={{ fontSize: 18 }} />
          </button>
          <span style={{ marginLeft: 12, fontSize: '0.95rem', fontWeight: 800, color: '#1A1A2E' }}>Settings</span>
        </div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 24, padding: '0 20px 20px' }}>
          ...
          <div>
            ...
            <div style={{ background: 'white', borderRadius: 16, border: '1px solid #E8E8F0', overflow: 'hidden', boxShadow: '0 1px 3px rgba(10,22,40,0.06), 0 1px 2px rgba(10,22,40,0.04)' }}>
              {/* IRS e-Services */}
              <div style={{ display: 'flex', alignItems: 'center', gap: 12, padding: '14px 16px', borderBottom: '1px solid #F0F0F5', cursor: 'pointer' }}>
                <div style={{ width: 38, height: 38, borderRadius: 10, background: '#EFF4FF', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
                  <i className="fas fa-landmark" style={{ fontSize: 15, color: '#1A1A2E' }} />
                </div>
                <div style={{ flex: 1, minWidth: 0 }}>
                  <div style={{ fontSize: '0.85rem', fontWeight: 600, color: '#1A1A2E' }}>IRS e-Services</div>
                ...
                <span style={{ fontSize: '0.75rem', fontWeight: 600, color: '#8585A0', cursor: 'pointer' }}>Disconnect</span>
              </div>
              {/* Plaid */}
              <div style={{ display: 'flex', alignItems: 'center', gap: 12, padding: '14px 16px', borderBottom: '1px solid #F0F0F5', cursor: 'pointer' }}>
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  <div style={{ fontSize: '0.85rem', fontWeight: 600, color: '#1A1A2E' }}>Plaid (Chase Bank)</div>
                  <div style={{ display: 'inline-flex', alignItems: 'center', gap: 4, marginTop: 3, padding: '2px 8px', background: '#E6F9EE', borderRadius: 9999, fontSize: '0.65rem', fontWeight: 600, color: '#00A651' }}>
                    <i className="fas fa-circle" style={{ fontSize: 5 }} /> Connected
                  </div>
                </div>
                <span style={{ fontSize: '0.75rem', fontWeight: 600, color: '#1A1A2E', cursor: 'pointer' }}>Manage</span>
              </div>
              {/* Google Account */}
              <div style={{ display: 'flex', alignItems: 'center', gap: 12, padding: '14px 16px', cursor: 'pointer' }}>
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  <div style={{ fontSize: '0.85rem', fontWeight: 600, color: '#1A1A2E' }}>Google Account</div>
                  <div style={{ display: 'inline-flex', alignItems: 'center', gap: 4, marginTop: 3, padding: '2px 8px', background: '#E6F9EE', borderRadius: 9999, fontSize: '0.65rem', fontWeight: 600, color: '#00A651' }}>
                    <i className="fas fa-circle" style={{ fontSize: 5 }} /> Connected
                  </div>
                </div>
          ...
          <div>
            ...
            <div style={{ background: 'white', borderRadius: 16, border: '1px solid #E8E8F0', overflow: 'hidden', boxShadow: '0 1px 3px rgba(10,22,40,0.06), 0 1px 2px rgba(10,22,40,0.04)' }}>
              {[
                { icon: 'fa-bell', label: 'Push Notifications', on: pushNotifs, toggle: () => setPushNotifs(!pushNotifs), iconColor: '#5C5C7A' },
                { icon: 'fa-envelope', label: 'Email Updates', on: emailUpdates, toggle: () => setEmailUpdates(!emailUpdates), iconColor: '#5C5C7A' },
                { icon: 'fa-circle-exclamation', label: 'Case Status Alerts', on: caseAlerts, toggle: () => setCaseAlerts(!caseAlerts), iconColor: '#5C5C7A' },
                { icon: 'fa-bullhorn', label: 'Marketing', on: marketing, toggle: () => setMarketing(!marketing), iconColor: '#B0B0C8' },
              ].map((item, i, arr) => (
                <div
                  key={item.label}
                  style={{
          ...
          <div>
            ...
            <div style={{ background: 'white', borderRadius: 16, border: '1px solid #E8E8F0', overflow: 'hidden', boxShadow: '0 1px 3px rgba(10,22,40,0.06), 0 1px 2px rgba(10,22,40,0.04)' }}>
              {/* Download My Data */}
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '14px 16px', borderBottom: '1px solid #F0F0F5', cursor: 'pointer' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                  <i className="fas fa-download" style={{ fontSize: 15, color: '#5C5C7A' }} />
                  <span style={{ fontSize: '0.85rem', fontWeight: 600, color: '#1A1A2E' }}>Download My Data</span>
                </div>
              ...
              >
                <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                  <i className="fas fa-shield-halved" style={{ fontSize: 15, color: '#5C5C7A' }} />
                  <span style={{ fontSize: '0.85rem', fontWeight: 600, color: '#1A1A2E' }}>Privacy Policy</span>
                </div>
              ...
              >
                <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                  <i className="fas fa-file-contract" style={{ fontSize: 15, color: '#5C5C7A' }} />
                  <span style={{ fontSize: '0.85rem', fontWeight: 600, color: '#1A1A2E' }}>Terms of Service</span>
                </div>
                <i className="fas fa-arrow-up-right-from-square" style={{ fontSize: 11, color: '#D5D5E0' }} />
              </Link>
            </div>
            ...
            <div style={{ background: 'white', borderRadius: 16, border: '1px solid #E8E8F0', overflow: 'hidden', boxShadow: '0 1px 3px rgba(10,22,40,0.06), 0 1px 2px rgba(10,22,40,0.04)' }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '14px 16px', borderBottom: '1px solid #F0F0F5', cursor: 'pointer' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                  ...
                  <span style={{ fontSize: '0.85rem', fontWeight: 600, color: '#1A1A2E' }}>Rate the App</span>
                </div>
                <i className="fas fa-arrow-up-right-from-square" style={{ fontSize: 11, color: '#D5D5E0' }} />
              </div>
              {/* Send Feedback */}
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '14px 16px', cursor: 'pointer' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                  <i className="fas fa-message" style={{ fontSize: 15, color: '#5C5C7A' }} />
                  <span style={{ fontSize: '0.85rem', fontWeight: 600, color: '#1A1A2E' }}>Send Feedback</span>
                </div>
                <i className="fas fa-chevron-right" style={{ fontSize: 11, color: '#D5D5E0' }} />
              </div>
            </div>
