  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <div className="flex items-center justify-between px-5 pt-4 pb-3">
        ...
        <h1 className="text-lg font-bold text-white">Cancel Subscription</h1>
        <div className="w-9" />
      </div>
      ...
      <div className="flex-1 overflow-y-auto px-5 pb-6 space-y-5">
        ...
        {/* What You'll Lose */}
        <div>
          <div className="text-xs font-bold text-zinc-600 uppercase tracking-wider mb-3">What you&apos;ll lose</div>
          <div className="flex flex-col gap-2.5">
            {lostFeatures.map((f) => (
              <div key={f} className="flex items-center gap-3 px-4 py-3 bg-zinc-900 rounded-xl border border-zinc-800">
        ...
        {/* Why are you leaving? */}
        <div>
          <div className="text-xs font-bold text-zinc-600 uppercase tracking-wider mb-3">Why are you leaving?</div>
          <div className="flex flex-col gap-2">
            {reasons.map((r, i) => (
              ...
              >
                <span className="text-sm text-zinc-400 w-[18px] text-center">{r.icon}</span>
                <span className="text-sm text-white font-medium flex-1">{r.label}</span>
                <div className={`w-5 h-5 rounded-full border-2 flex items-center justify-center ${
                  selectedReason === i ? 'border-blue-500 bg-blue-500' : 'border-zinc-700'
                }`}>
        ...
        {/* Retention Offer */}
        <div className="bg-blue-500/10 border-[1.5px] border-blue-500 rounded-2xl p-[18px] relative overflow-hidden">
          ...
          <div className="flex items-center gap-2 mb-2.5">
            ...
            <span className="text-xs font-bold text-blue-400 uppercase tracking-wide">Special Offer</span>
          </div>
          <div className="text-sm font-bold text-white leading-snug mb-1">Stay on Pro and get 30% off your next 3 months</div>
          <div className="text-sm text-zinc-400 mb-3.5">
            <span className="text-lg font-extrabold text-blue-400">$34.30</span>
            <span className="font-medium">/mo instead of $49.00</span>
          </div>
          <button className="w-full py-3 bg-transparent text-blue-400 border border-blue-500 rounded-full text-sm font-semibold hover:bg-blue-500 hover:text-white transition-colors">
        ...
        <div className="flex flex-col gap-2.5 pt-1">
          <Link
            ...
            className="w-full flex items-center justify-center py-3.5 bg-transparent text-red-400 border border-red-500 rounded-full text-sm font-semibold hover:bg-red-500 hover:text-white transition-colors"
          >
            Continue Cancellation
          </Link>
          <Link
            href="/billing"
            className="w-full flex items-center justify-center gap-1 py-3.5 bg-green-600 text-white rounded-full text-sm font-semibold hover:bg-green-700 transition-colors"
          >
