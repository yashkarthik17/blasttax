  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <div className="flex items-center justify-between px-5 pt-4 pb-3">
        ...
        <h1 className="text-lg font-bold text-[#1A1A2E]">Checkout</h1>
        <div className="w-10" />
      </div>
      ...
      <div className="flex-1 overflow-y-auto px-5 pb-6 space-y-4">
        ...
        <div className="bg-white border border-[#F0F0F5] rounded-2xl p-[18px]">
          <div className="flex items-center justify-between mb-3.5">
            <div>
              <p className="text-[0.9375rem] font-bold text-[#1A1A2E]">Pro Plan</p>
              <p className="text-xs text-[#8585A0] mt-0.5">Monthly subscription</p>
            </div>
          ...
          <div className="border-t border-[#F0F0F5] pt-3 space-y-1.5">
            <div className="flex justify-between">
              <span className="text-sm text-[#8585A0]">Subtotal</span>
              <span className="text-sm font-semibold text-[#1A1A2E]">$49.00</span>
            </div>
            <div className="flex justify-between">
              <span className="text-sm text-[#8585A0]">Tax</span>
              <span className="text-sm font-semibold text-[#1A1A2E]">$0.00</span>
            </div>
            <div className="border-t border-dashed border-[#D5D5E0] pt-2 mt-2 flex justify-between">
              <span className="text-sm font-bold text-[#1A1A2E]">Total</span>
              <span className="text-sm font-extrabold text-[#1A1A2E]">$49.00</span>
            </div>
          </div>
        </div>
        ...
        <div className="flex gap-2">
          <input
            ...
            className="flex-1 px-3.5 py-3 bg-white border border-[#F0F0F5] rounded-xl text-sm text-[#1A1A2E] placeholder-zinc-600 focus:border-blue-500 focus:outline-none transition-colors"
          />
          <button className="px-4.5 py-3 bg-white text-[#1A1A2E] rounded-xl text-sm font-semibold hover:bg-[#D5D5E0] transition-colors whitespace-nowrap">
            Apply
          </button>
        </div>
        ...
        <div>
          <div className="flex items-center gap-2 mb-3.5">
            ...
            <span className="text-sm font-bold text-[#1A1A2E]">Card Details</span>
          </div>

          <label className="block text-xs font-semibold text-[#8585A0] uppercase tracking-wide mb-1.5">Card Number</label>
          <div className="grid grid-cols-4 gap-2 mb-3">
            {[1, 2, 3, 4].map((n) => (
              <input key={n} type="text" placeholder="4242" maxLength={4} className="w-full px-2 py-3 bg-white border border-[#F0F0F5] rounded-xl text-sm text-[#1A1A2E] text-center tracking-wider placeholder-zinc-600 focus:border-blue-500 focus:outline-none transition-colors" />
            ))}
          </div>

          <div className="grid grid-cols-2 gap-2.5 mb-3">
            <div>
              <label className="block text-xs font-semibold text-[#8585A0] uppercase tracking-wide mb-1.5">Expiry</label>
        ...
        <div>
          <div className="flex items-center gap-2 mb-3">
            ...
            <span className="text-sm font-bold text-[#1A1A2E]">Billing Address</span>
          </div>

          <label className="flex items-center gap-2.5 mb-3.5 cursor-pointer" onClick={() => setSameAddress(!sameAddress)}>
            <div className={`w-5 h-5 rounded-md flex items-center justify-center flex-shrink-0 ${sameAddress ? 'bg-[#2563EB]' : 'bg-[#F0F0F5] border border-[#D5D5E0]'}`}>
              {sameAddress && (
                <svg className="h-2.5 w-2.5 text-[#1A1A2E]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={3}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" />
                </svg>
              )}
            </div>
            <span className="text-sm text-[#1A1A2E] font-medium">Same as account address</span>
          </label>

          <div className="px-3.5 py-3 bg-white border border-[#F0F0F5] rounded-xl">
            <p className="text-sm text-[#8585A0]">123 Main Street, Apt 4B</p>
            <p className="text-sm text-[#8585A0]">New York, NY 10001</p>
          </div>
        </div>
        ...
        <div className="text-center">
          <p className="text-[0.6875rem] text-[#8585A0] leading-relaxed">
