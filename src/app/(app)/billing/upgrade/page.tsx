  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <div className="flex items-center justify-between px-5 pt-4 pb-3">
        ...
        <h1 className="text-lg font-bold text-[#0A1628]">Confirm Upgrade</h1>
        <div className="w-10" />
      </div>
      ...
      <div className="flex-1 overflow-y-auto px-5 pb-6 space-y-4">
        ...
        <div className="bg-white border border-[#F1F5F9] rounded-2xl p-5">
          <div className="flex items-center justify-center gap-4">
            {/* Current Plan */}
            <div className="flex-1 text-center py-3.5 px-2 bg-[#F1F5F9] rounded-[14px] border border-[#E2E8F0]">
              <div className="w-9 h-9 rounded-[10px] bg-[#E2E8F0] flex items-center justify-center mx-auto mb-2">
              ...
              <p className="text-[0.6875rem] font-semibold text-[#94A3B8] uppercase tracking-wide mb-0.5">Current</p>
              <p className="text-[0.9375rem] font-extrabold text-[#0A1628]">Free</p>
              <p className="text-xs text-[#94A3B8] mt-0.5">$0/mo</p>
            </div>
            ...
            <div className="flex-1 text-center py-3.5 px-2 bg-[#2563EB]/10 rounded-[14px] border border-blue-500">
              ...
              <p className="text-[0.9375rem] font-extrabold text-[#0A1628]">Pro</p>
        ...
        <div className="bg-white border border-[#F1F5F9] rounded-2xl p-[18px]">
          <p className="text-sm font-bold text-[#0A1628] mb-3.5">What you&apos;re getting</p>
          <div className="flex flex-col gap-2.5">
            {benefits.map((b) => (
              <div key={b} className="flex items-center gap-2.5">
                ...
                <span className="text-sm text-[#0A1628] font-medium">{b}</span>
              </div>
            ))}
          </div>
        </div>
        ...
        {/* Price Breakdown */}
        <div className="bg-white border border-[#F1F5F9] rounded-2xl p-[18px]">
          <p className="text-sm font-bold text-[#0A1628] mb-3">Price Breakdown</p>
          <div className="flex items-center gap-2 mb-2.5">
            <span className="text-xl font-extrabold text-[#94A3B8] line-through">$0</span>
            <svg className="h-3 w-3 text-[#94A3B8]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
              <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 4.5L21 12m0 0l-7.5 7.5M21 12H3" />
            </svg>
            <span className="text-xl font-extrabold text-[#0A1628]">$49</span>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div className="w-10 h-7 rounded-md bg-white flex items-center justify-center">
                <span className="text-[0.625rem] font-extrabold text-[#0A1628] tracking-wide">VISA</span>
              </div>
              <div>
                <p className="text-sm font-semibold text-[#0A1628]">Visa ending 4242</p>
                <p className="text-[0.6875rem] text-[#94A3B8]">Exp 08/28</p>
              </div>
            </div>
        ...
        <div className="text-center">
          <div className="inline-flex items-center gap-1.5 px-4 py-2 bg-white rounded-full">
            ...
            <span className="text-xs font-semibold text-[#64748B]">Cancel anytime during trial — no charge</span>
          </div>
        </div>
      </div>
    </div>
