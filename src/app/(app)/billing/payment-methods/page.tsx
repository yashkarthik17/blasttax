  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <div className="flex items-center justify-between px-5 pt-4 pb-3">
        ...
        <h1 className="text-lg font-bold text-[#0A1628]">Payment Methods</h1>
        <div className="w-10" />
      </div>

      <div className="flex-1 overflow-y-auto px-5 pb-6 space-y-4">
        {/* Section Label */}
        <p className="text-[0.6875rem] font-bold text-[#94A3B8] uppercase tracking-wide">Your Cards</p>
        ...
        <div className="bg-white border border-blue-500 rounded-2xl px-[18px] py-4">
          <div className="flex items-start gap-3.5">
            <div className="w-12 h-[34px] rounded-lg bg-white flex items-center justify-center flex-shrink-0">
              <span className="text-[0.6875rem] font-extrabold text-[#0A1628] tracking-wide">VISA</span>
            </div>
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-2 mb-0.5">
                <p className="text-sm font-bold text-[#0A1628]">Visa ending 4242</p>
                <span className="px-2 py-0.5 bg-[#2563EB]/10 rounded-full text-[0.625rem] font-bold text-[#2563EB]">Default</span>
              </div>
              <p className="text-xs text-[#94A3B8] font-medium">Expires 08/28</p>
            </div>
            <div className="flex gap-1 flex-shrink-0">
              <button className="w-8 h-8 rounded-lg bg-[#F1F5F9] flex items-center justify-center hover:bg-[#E2E8F0] transition-colors">
        ...
        <Link
          ...
          className="w-full flex items-center justify-center gap-2.5 py-3.5 bg-white border border-dashed border-[#E2E8F0] rounded-[14px] hover:border-blue-500 hover:bg-[#1D4ED8]/5 transition-colors"
        >
        ...
        {/* Autopay Settings */}
        <div>
          <p className="text-[0.6875rem] font-bold text-[#94A3B8] uppercase tracking-wide mb-3.5">Autopay Settings</p>

          <div className="bg-white border border-[#F1F5F9] rounded-2xl px-[18px] py-4">
            <div className="flex items-center justify-between mb-3.5">
              <div className="flex-1 min-w-0">
                <p className="text-sm font-semibold text-[#0A1628]">Auto-renew subscription</p>
                <p className="text-xs text-[#94A3B8] mt-0.5">Automatically renew at end of period</p>
              </div>
              <button
                onClick={() => setAutoRenew(!autoRenew)}
                className={`w-11 h-6 rounded-full relative transition-colors flex-shrink-0 ${autoRenew ? 'bg-[#00A651]' : 'bg-[#E2E8F0]'}`}
              >
            ...
            <div className="px-3.5 py-2.5 bg-[#F1F5F9] rounded-[10px] border border-[#E2E8F0]">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm text-[#64748B] font-medium">
                  Your card will be charged <strong className="text-[#0A1628] font-bold">$49.00</strong> on <strong className="text-[#0A1628] font-bold">April 15, 2026</strong>
                </span>
              </div>
            </div>
          </div>
