    ...
    <div className="flex flex-col min-h-screen items-center justify-center px-6 relative">
      ...
      <div className="relative z-10 flex flex-col items-center gap-5 w-full">
        ...
        <div className="text-center">
          <h1 className="text-2xl font-extrabold text-white mb-1">Payment Successful!</h1>
          <p className="text-sm text-zinc-400 font-medium">Your Pro Plan is now active</p>
        </div>

        {/* Receipt Summary Card */}
        <div className="w-full bg-zinc-900 border border-zinc-800 rounded-2xl p-[18px]">
          <div className="flex items-center gap-2 mb-3.5">
            ...
            <span className="text-sm font-bold text-white">Receipt Summary</span>
          </div>
          ...
          <div className="flex flex-col gap-2.5">
            {receiptItems.map((item, i) => (
              <div key={item.label}>
                ...
                {i === 2 && <div className="h-px bg-zinc-800 mt-2.5" />}
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="flex items-center gap-1.5 text-center">
          ...
          <span className="text-xs text-zinc-500 font-medium">Receipt sent to jane@email.com</span>
        </div>
        ...
        <div className="w-full flex flex-col gap-2.5 mt-1">
          <Link
            href="/dashboard"
            className="w-full flex items-center justify-center py-4 bg-white text-zinc-900 rounded-full text-[0.9375rem] font-bold hover:bg-zinc-200 transition-colors"
          >
            Go to Dashboard
          </Link>
          <Link
            href="/billing"
            className="w-full flex items-center justify-center py-3.5 bg-zinc-900 border border-zinc-800 text-white rounded-full text-sm font-semibold hover:border-zinc-600 transition-colors"
          >
            View Billing
          </Link>
        </div>
