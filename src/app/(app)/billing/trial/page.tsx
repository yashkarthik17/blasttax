  ...
  return (
    <div className="flex flex-col min-h-screen items-center text-center px-6 pt-8 pb-6">
      ...
      <div className="w-[88px] h-[88px] rounded-full bg-gradient-to-br from-blue-500/15 to-blue-500/5 flex items-center justify-center mb-5 relative shadow-lg shadow-blue-500/15">
        <svg className="h-[34px] w-[34px] text-blue-400 animate-bounce" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} style={{ animationDuration: '3s' }}>
      ...
      {/* Heading */}
      <h1 className="text-[1.4rem] font-extrabold text-white leading-tight mb-2">Your Pro Trial is Active!</h1>
      <p className="text-sm text-zinc-400 leading-relaxed mb-[18px] max-w-[280px]">
      ...
      <div className="inline-flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-blue-500/10 via-blue-500/5 to-blue-500/10 rounded-full border border-blue-500/30 mb-6">
        ...
        <span className="text-sm font-bold text-blue-300">6 days, 23 hours remaining</span>
      </div>

      {/* What You Can Do Now */}
      <div className="w-full text-left mb-2">
        <div className="text-xs font-bold text-zinc-600 uppercase tracking-wider mb-3">What you can do now</div>
      </div>

      {/* Feature Cards */}
      <div className="w-full flex flex-col gap-2.5 mb-5">
        {features.map((f) => (
          <div key={f.title} className="flex items-center gap-3.5 p-4 bg-zinc-900 border border-zinc-800 rounded-[14px] hover:border-zinc-700 transition-colors cursor-pointer">
            ...
            <div className="text-left flex-1">
              <div className="text-sm font-semibold text-white leading-snug">{f.title}</div>
      ...
      {/* Reminder Note */}
      <div className="w-full bg-zinc-900 border border-zinc-800 rounded-[10px] px-3.5 py-3 flex items-center gap-2.5 mb-[22px]">
        ...
        <span className="text-xs text-zinc-400 leading-snug text-left">
          We&apos;ll remind you <strong className="font-semibold text-white">2 days</strong> before your trial ends.
        </span>
      </div>
      ...
      <div className="w-full mb-3">
        <Link
          href="/dashboard"
          className="w-full flex items-center justify-center gap-1.5 py-3.5 bg-green-600 text-white rounded-full text-sm font-semibold shadow-lg shadow-green-600/20 hover:bg-green-700 transition-colors"
        >
      ...
      <div className="pt-0.5">
        <a href="#" className="text-xs text-zinc-500 font-medium hover:text-blue-400 transition-colors">
