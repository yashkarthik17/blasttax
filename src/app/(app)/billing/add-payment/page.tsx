  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <div className="flex items-center justify-between px-5 pt-4 pb-3">
        <Link href="/billing/payment-methods" className="w-9 h-9 rounded-xl bg-[#F1F5F9] flex items-center justify-center">
          <svg className="h-4 w-4 text-[#64748B]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
            <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 19.5L8.25 12l7.5-7.5" />
          </svg>
        </Link>
        <h1 className="text-lg font-bold text-[#0A1628]">Add Card</h1>
        <div className="w-10" />
      </div>
      ...
      <div className="flex-1 overflow-y-auto px-5 pb-6 space-y-4">
        ...
        <div className="bg-gradient-to-br from-zinc-900 via-zinc-800 to-zinc-900 rounded-2xl p-5 relative overflow-hidden" style={{ aspectRatio: '1.586' }}>
          ...
          <div className="flex flex-col justify-between h-full relative z-10">
            <div className="flex items-center justify-between">
              ...
              <svg className="h-[18px] w-[18px] text-[#0A1628]/40 rotate-90" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M8.288 15.038a5.25 5.25 0 017.424 0M5.106 11.856c3.807-3.808 9.98-3.808 13.788 0M1.924 8.674c5.565-5.565 14.587-5.565 20.152 0M12.53 18.22l-.53.53-.53-.53a.75.75 0 011.06 0z" />
              </svg>
            </div>
            <div>
              <p className="text-lg font-semibold text-[#0A1628] tracking-[0.15em] mb-3.5 font-mono">4242  4242  4242  4242</p>
              <div className="flex justify-between items-end">
                <div>
                  <p className="text-[0.5625rem] text-[#0A1628]/45 uppercase tracking-wider mb-0.5">Card Holder</p>
                  <p className="text-sm font-semibold text-[#0A1628] tracking-wide">JANE DOE</p>
                </div>
                <div className="text-right">
                  <p className="text-[0.5625rem] text-[#0A1628]/45 uppercase tracking-wider mb-0.5">Expires</p>
                  <p className="text-sm font-semibold text-[#0A1628]">08/28</p>
                </div>
                <div className="text-right">
                  <span className="text-xs font-extrabold text-[#0A1628]/50 tracking-wide">VISA</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div>
          ...
          <div className="relative">
            <input type="text" placeholder="1234 5678 9012 3456" className="w-full px-3.5 py-3 pr-11 bg-white border border-[#F1F5F9] rounded-xl text-sm text-[#0A1628] tracking-wider placeholder-zinc-600 focus:border-blue-500 focus:outline-none transition-colors" />
            <svg className="absolute right-3.5 top-1/2 -translate-y-1/2 h-4 w-4 text-[#94A3B8]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        ...
        <div className="grid grid-cols-2 gap-2.5">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <svg className="absolute right-3.5 top-1/2 -translate-y-1/2 h-3 w-3 text-[#94A3B8]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        ...
        <label className="flex items-center gap-3 cursor-pointer py-1">
          <button
            ...
            className={`w-[22px] h-[22px] rounded-md flex items-center justify-center flex-shrink-0 transition-colors ${setDefault ? 'bg-[#2563EB] border-blue-500' : 'bg-white border-2 border-[#E2E8F0]'}`}
          >
            {setDefault && (
          ...
          <span className="text-sm text-[#0A1628] font-medium">Set as default payment method</span>
        </label>
        ...
        <div>
          <div className="flex items-center justify-center gap-4 py-3">
            <div className="flex items-center gap-1.5 px-3 py-1.5 bg-white rounded-lg border border-[#F1F5F9]">
              <span className="text-sm font-bold text-violet-400">S</span>
              <span className="text-[0.6875rem] font-semibold text-[#94A3B8]">Stripe</span>
            </div>
            <div className="flex items-center gap-1.5 px-3 py-1.5 bg-white rounded-lg border border-[#F1F5F9]">
              ...
              <span className="text-[0.6875rem] font-semibold text-[#94A3B8]">PCI</span>
            </div>
            <div className="flex items-center gap-1.5 px-3 py-1.5 bg-white rounded-lg border border-[#F1F5F9]">
              <svg className="h-3 w-3 text-[#2563EB]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 10.5V6.75a4.5 4.5 0 10-9 0v3.75m-.75 11.25h10.5a2.25 2.25 0 002.25-2.25v-6.75a2.25 2.25 0 00-2.25-2.25H6.75a2.25 2.25 0 00-2.25 2.25v6.75a2.25 2.25 0 002.25 2.25z" />
              </svg>
              <span className="text-[0.6875rem] font-semibold text-[#94A3B8]">SSL</span>
            </div>
          </div>
          <p className="text-center text-[0.6875rem] text-[#94A3B8] leading-snug">
