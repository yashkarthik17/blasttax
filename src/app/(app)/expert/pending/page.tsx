        ...
        <div className="flex flex-col items-center px-6 py-8 gap-0">
          ...
          <div className="mb-6">
            <div className="relative w-40 h-40 mx-auto">
              {/* Outer dashed ring */}
              <div className="absolute inset-0 border-[3px] border-dashed border-[#D5D5E0] rounded-full animate-[spin_12s_linear_infinite]" />
              {/* Inner ring */}
              ...
              {/* Center icon */}
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-14 h-14 rounded-full bg-[#1A1A2E] flex items-center justify-center">
            ...
            <div className="text-center mt-4">
              <span className="text-[0.85rem] font-bold text-[#1A1A2E]">Matching</span>
              <div className="flex gap-1.5 justify-center mt-4">
                <span className="w-1.5 h-1.5 rounded-full bg-[#1A1A2E] animate-bounce" />
                <span className="w-1.5 h-1.5 rounded-full bg-[#1A1A2E] animate-bounce" style={{ animationDelay: '0.2s' }} />
                <span className="w-1.5 h-1.5 rounded-full bg-[#1A1A2E] animate-bounce" style={{ animationDelay: '0.4s' }} />
              </div>
            </div>
          </div>
          ...
          <div className="text-center mb-5">
            <h1 className="text-2xl font-extrabold text-[#1A1A2E] tracking-tight mb-2">Finding your expert</h1>
            <p className="text-[0.88rem] text-[#8585A0] font-normal leading-relaxed max-w-[280px] mx-auto">We&apos;re matching you with the best tax professional for your case</p>
          </div>

          {/* Case Details Card */}
          <div className="w-full bg-white rounded-2xl p-4 border border-[#D5D5E0] mb-4 text-left">
            <div className="flex items-center gap-2.5">
              ...
              <div className="flex-1">
                <div className="text-[0.85rem] font-bold text-[#1A1A2E]">Case #1042</div>
                <div className="text-[0.72rem] text-[#8585A0]">Offer in Compromise</div>
              </div>
              <div className="text-right">
                <div className="text-base font-extrabold text-[#E63946]">$47,250</div>
                <div className="text-[0.65rem] text-[#8585A0]">Total debt</div>
              </div>
            </div>
          </div>
          ...
          <div className="w-full bg-white rounded-2xl p-4 border border-[#D5D5E0] mb-4 text-left">
            <div className="text-xs font-bold text-[#B0B0C8] uppercase tracking-wider mb-3">What we&apos;re looking for</div>
          ...
          {/* Average match time */}
          <div className="text-center mb-5">
            <div className="text-[0.78rem] text-[#8585A0] mb-1.5">
              <svg className="w-3 h-3 inline mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
              </svg>
              Average match time: <strong className="text-[#1A1A2E]">2-4 hours</strong>
            </div>
            <div className="text-[0.78rem] text-[#8585A0]">
              <svg className="w-3 h-3 inline mr-1 text-[#1A1A2E]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
          ...
          <div className="w-full bg-white rounded-2xl p-4 border border-[#D5D5E0] mb-5 text-left">
            <div className="text-xs font-bold text-[#B0B0C8] uppercase tracking-wider mb-3">Notification Preference</div>
            <div className="flex flex-col gap-3">
              <button
                onClick={() => setNotifications(n => ({ ...n, push: !n.push }))}
                className="flex items-center gap-2.5 cursor-pointer"
              >
                <div className={`w-[22px] h-[22px] rounded-md border-2 flex items-center justify-center shrink-0 transition-colors ${notifications.push ? 'bg-[#1A1A2E] border-[#1A1A2E]' : 'border-[#D5D5E0]'}`}>
                  {notifications.push && (
                ...
                <span className="text-[0.85rem] font-semibold text-[#1A1A2E]">Push Notifications</span>
              </button>
              <button
                onClick={() => setNotifications(n => ({ ...n, email: !n.email }))}
                className="flex items-center gap-2.5 cursor-pointer"
              >
                <div className={`w-[22px] h-[22px] rounded-md border-2 flex items-center justify-center shrink-0 transition-colors ${notifications.email ? 'bg-[#1A1A2E] border-[#1A1A2E]' : 'border-[#D5D5E0]'}`}>
                  {notifications.email && (
                    <svg className="w-3 h-3 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={3}>
                      <path strokeLinecap="round" strokeLinejoin="round" d="m4.5 12.75 6 6 9-13.5" />
                    </svg>
                ...
                <span className="text-[0.85rem] font-semibold text-[#1A1A2E]">Email</span>
              </button>
            </div>
          </div>
