    ...
    <div className="min-h-screen bg-[#F8FAFC] flex flex-col">
      <div className="mx-auto max-w-md w-full flex flex-col flex-1">
        ...
        <div className="flex items-center gap-3 px-5 py-4 border-b border-[#E2E8F0]">
          <Link href="/expert/workspace" className="flex h-10 w-10 items-center justify-center rounded-xl bg-white border border-[#F1F5F9]">
          ...
          <div className="flex-1">
            <div className="text-[0.88rem] font-bold text-[#0A1628]">Michael Chen, EA</div>
            <div className="flex items-center gap-1">
              <span className="w-1.5 h-1.5 rounded-full bg-[#00A651]" />
              <span className="text-[0.7rem] text-[#00A651] font-medium">Online</span>
            </div>
          </div>
          <button className="flex h-10 w-10 items-center justify-center rounded-xl bg-white border border-[#F1F5F9]">
        ...
        <div className="flex-1 overflow-y-auto px-5 py-4 flex flex-col gap-4 relative">
          ...
          <div className="text-center">
            <span className="text-[0.68rem] font-semibold text-[#CBD5E1] bg-[#F8FAFC] px-3 py-1 rounded-full border border-[#F1F5F9]">Today, 10:24 AM</span>
          </div>

          {/* Expert message 1 */}
          <div className="flex items-end gap-2">
            <div className="w-7 h-7 rounded-full bg-[#0A1628] flex items-center justify-center shrink-0">
              <span className="text-[0.6rem] font-bold text-white">MC</span>
            </div>
            <div className="bg-white border border-[#E2E8F0] rounded-[18px_18px_18px_4px] px-4 py-3 text-[0.84rem] text-[#0A1628] leading-relaxed max-w-[82%] shadow-sm">
          ...
          {/* User message */}
          <div>
            <div className="bg-[#0A1628] rounded-[18px_18px_4px_18px] px-4 py-3 text-[0.84rem] text-white leading-relaxed max-w-[82%] ml-auto shadow-sm">
              That makes sense. Should I include the receipts from last year too?
            </div>
            <div className="text-right mt-1">
              <span className="text-[0.65rem] text-[#CBD5E1]">10:28 AM</span>
          ...
          <div className="flex items-end gap-2">
            ...
            <div className="max-w-[82%]">
              <div className="bg-[#F8FAFC] border border-[#E2E8F0] rounded-xl p-2.5 flex items-center gap-2.5 cursor-pointer hover:bg-[#EFF4FF] hover:border-[rgba(0,61,165,0.15)] transition">
                ...
                <div className="flex-1 min-w-0">
                  <div className="text-[0.8rem] font-semibold text-[#0A1628] truncate">OIC_Tips_Guide.pdf</div>
                  <div className="text-[0.68rem] text-[#94A3B8]">245 KB</div>
                </div>
                <svg className="w-[13px] h-[13px] text-[#0A1628]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M3 16.5v2.25A2.25 2.25 0 0 0 5.25 21h13.5A2.25 2.25 0 0 0 21 18.75V16.5M16.5 12 12 16.5m0 0L7.5 12m4.5 4.5V3" />
                </svg>
              </div>
              <div className="mt-1">
                <span className="text-[0.65rem] text-[#CBD5E1]">10:31 AM</span>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-end gap-2">
            ...
            <div className="bg-white border border-[#E2E8F0] rounded-[18px_18px_18px_4px] px-[18px] py-3.5 flex gap-[5px] items-center">
              <span className="w-[7px] h-[7px] rounded-full bg-[#CBD5E1] animate-bounce" />
              <span className="w-[7px] h-[7px] rounded-full bg-[#CBD5E1] animate-bounce" style={{ animationDelay: '0.2s' }} />
              <span className="w-[7px] h-[7px] rounded-full bg-[#CBD5E1] animate-bounce" style={{ animationDelay: '0.4s' }} />
            </div>
          </div>
        ...
        <div className="px-4 py-3 bg-white border-t border-[#E2E8F0] shrink-0">
          <div className="flex items-center gap-2.5 bg-[#F8FAFC] border-[1.5px] border-[#E2E8F0] rounded-full py-1.5 px-2 pl-4">
            ...
            <input
              ...
              className="flex-1 border-none outline-none text-[0.84rem] text-[#0A1628] bg-transparent placeholder:text-[#94A3B8]"
            />
            <button className="w-9 h-9 rounded-full bg-[#0A1628] flex items-center justify-center shrink-0 shadow-sm">
