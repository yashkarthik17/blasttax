  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC]">
      ...
      <div className="flex items-center justify-between px-5 py-3.5">
        ...
        <div className="flex-1 text-center text-[0.95rem] font-extrabold text-[#0A1628]">Currently Not Collectible</div>
        <div className="w-9 shrink-0" />
      </div>

      <div className="flex flex-col gap-[18px] px-5 pb-10">
        {/* Heading */}
        <h1 className="text-[1.25rem] font-extrabold text-[#0A1628] tracking-tight leading-tight">
        ...
        <div className="rounded-2xl border border-[rgba(0,61,165,0.1)] bg-white p-[18px]">
          <div className="flex gap-3">
            <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-[rgba(0,61,165,0.1)] shrink-0">
              <svg className="h-4 w-4 text-[#0A1628]" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 15h-2v-6h2v6zm0-8h-2V7h2v2z"/></svg>
            </div>
            <p className="text-[0.82rem] text-[#0A1628] leading-relaxed font-medium">
              When your monthly disposable income (MDI) is <strong className="text-[#0A1628]">$0 or below</strong>, the IRS may classify your account as Currently Not Collectible &mdash; pausing all active collection efforts.
            </p>
          </div>
        </div>
        ...
        {/* Your Eligibility */}
        <div>
          <div className="text-[0.75rem] font-bold text-[#CBD5E1] uppercase tracking-wider mb-2.5">Your Eligibility</div>
          <div className="rounded-2xl border-[1.5px] border-[#00A651] bg-white p-5 shadow-[0_1px_2px_rgba(0,0,0,0.03)]">
            ...
            <div className="flex items-center gap-2 mb-4">
              ...
              <div>
                ...
                <div className="text-[0.7rem] text-[#94A3B8]">Based on your financial analysis</div>
              </div>
            </div>

            {/* MDI */}
            <div className="flex items-center justify-between py-3 border-t border-[#F1F5F9]">
              <span className="text-[0.82rem] font-semibold text-[#64748B]">Monthly Disposable Income</span>
              <span className="text-[1.1rem] font-black text-[#00A651]">$0</span>
            </div>

            {/* Income */}
            <div className="flex items-center justify-between py-3 border-t border-[#F1F5F9]">
              <span className="text-[0.82rem] font-semibold text-[#64748B]">Monthly Income</span>
              <span className="text-[0.88rem] font-bold text-[#0A1628]">$4,700</span>
            </div>

            {/* Expenses */}
            <div className="flex items-center justify-between py-3 border-t border-[#F1F5F9]">
              <span className="text-[0.82rem] font-semibold text-[#64748B]">IRS Allowable Expenses</span>
              <span className="text-[0.88rem] font-bold text-[#0A1628]">$4,700</span>
            </div>
          </div>
        </div>
        ...
        <div>
          <div className="text-[0.75rem] font-bold text-[#CBD5E1] uppercase tracking-wider mb-2.5">What Happens with CNC</div>
          <div className="rounded-2xl border border-[#E2E8F0] bg-white p-4 flex flex-col gap-3">
            {/* Benefits */}
            {BENEFITS.map((item) => (
              <div key={item.title} className="flex items-start gap-2.5">
                ...
                <div>
                  <div className="text-[0.85rem] font-semibold text-[#0A1628]">{item.title}</div>
                  <div className="text-[0.72rem] text-[#94A3B8] mt-0.5">{item.desc}</div>
                </div>
              </div>
            ))}
        ...
        {/* Comparison Table */}
        <div>
          <div className="text-[0.75rem] font-bold text-[#CBD5E1] uppercase tracking-wider mb-2.5">Compare Options</div>
          <div className="rounded-2xl border border-[#E2E8F0] bg-white p-1 overflow-hidden">
            <table className="w-full border-collapse">
              <thead>
                <tr>
                  <th className="p-2 text-[0.68rem] font-bold text-[#64748B] text-left bg-[#F8FAFC] rounded-tl-xl" />
                  <th className="p-2 text-[0.68rem] font-bold text-[#0A1628] text-center bg-[#EBF0FF]">CNC</th>
                  <th className="p-2 text-[0.68rem] font-bold text-[#64748B] text-center bg-[#F8FAFC]">IA</th>
                  <th className="p-2 text-[0.68rem] font-bold text-[#64748B] text-center bg-[#F8FAFC] rounded-tr-xl">OIC</th>
                </tr>
              </thead>
              <tbody>
                {COMPARISON.map((row) => (
                  <tr key={row.label} className="border-b border-[#F1F5F9] last:border-b-0">
                    <td className="p-2 text-[0.68rem] font-semibold text-[#0A1628] text-left">{row.label}</td>
                    <td className="p-2 text-[0.68rem] font-medium text-[#0A1628] text-center">
        ...
        <div className="flex flex-col gap-3 pt-1">
          ...
          <button
            onClick={() => router.back()}
            className="w-full py-3 text-center text-[#94A3B8] text-[0.82rem] font-semibold transition-all hover:-translate-y-0.5 active:scale-[0.97]"
          >
