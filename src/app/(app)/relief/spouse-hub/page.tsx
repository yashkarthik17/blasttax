    ...
    <div style={{ minHeight: '100vh', background: '#F8FAFC' }}>
      <div style={{ maxWidth: '28rem', margin: '0 auto' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '14px 20px 12px' }}>
          <div
            onClick={() => router.back()}
            style={{ width: 36, height: 36, borderRadius: 12, background: '#F8FAFC', border: '1px solid #F3F4F6', display: 'flex', alignItems: 'center', justifyContent: 'center', cursor: 'pointer', flexShrink: 0 }}
          >
            <i className="fas fa-arrow-left" style={{ fontSize: 14, color: '#64748B' }} />
          </div>
          <div style={{ flex: 1, fontSize: '0.95rem', fontWeight: 800, color: '#0A1628', textAlign: 'center' }}>Spouse Relief</div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 14, padding: '8px 20px 20px' }}>
          {/* Heading */}
          <div>
            <div style={{ fontSize: '1.25rem', fontWeight: 800, color: '#0A1628', letterSpacing: '-0.01em', lineHeight: 1.3 }}>Spouse Tax Relief</div>
            <div style={{ fontSize: '0.78rem', color: '#94A3B8', marginTop: 4, lineHeight: 1.5 }}>Choose the type of relief that fits your situation</div>
          </div>

          {/* Innocent Spouse Card */}
          <Link
            href="/forms/form-8857"
            style={{ textDecoration: 'none', display: 'block', background: 'white', border: '1.5px solid #F3F4F6', borderRadius: 16, padding: 20, cursor: 'pointer' }}
          >
            <div style={{ display: 'flex', alignItems: 'flex-start', gap: 14 }}>
              ...
              <div style={{ flex: 1 }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 4 }}>
                  <span style={{ fontSize: '0.92rem', fontWeight: 800, color: '#0A1628' }}>Innocent Spouse</span>
          ...
          >
            <div style={{ display: 'flex', alignItems: 'flex-start', gap: 14 }}>
              ...
              <div style={{ flex: 1 }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 4 }}>
                  <span style={{ fontSize: '0.92rem', fontWeight: 800, color: '#0A1628' }}>Injured Spouse</span>
          ...
          <div
            style={{ background: 'white', border: '1px solid #E2E8F0', borderRadius: 14, overflow: 'hidden', cursor: 'pointer', ...(comparisonOpen ? { borderColor: 'rgba(10,22,40,0.15)' } : {}) }}
          >
            <div
            ...
            >
              <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                ...
                <span style={{ fontSize: '0.85rem', fontWeight: 700, color: '#0A1628' }}>Which do I need?</span>
              </div>
              <i className="fas fa-chevron-down" style={{ fontSize: 11, color: '#CBD5E1', transition: 'transform 0.3s ease', transform: comparisonOpen ? 'rotate(180deg)' : 'rotate(0deg)' }} />
            </div>
              ...
              <div style={{ padding: '0 16px 16px' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 10, marginBottom: 14 }}>
                  <div style={{ padding: '10px 12px', background: '#F5F0FF', borderRadius: 10 }}>
                    ...
                    <div style={{ fontSize: '0.72rem', color: '#64748B', lineHeight: 1.5 }}>You were wrongly assessed tax due to your spouse&apos;s actions &mdash; underreported income, false deductions, or fraud on a joint return.</div>
                  </div>
                  <div style={{ padding: '10px 12px', background: '#FFF0F1', borderRadius: 10 }}>
                    ...
                    <div style={{ fontSize: '0.72rem', color: '#64748B', lineHeight: 1.5 }}>Your share of a joint refund was taken (offset) to pay your spouse&apos;s separate debt &mdash; past-due child support, federal student loans, or prior-year taxes.</div>
                  </div>
                  <div style={{ padding: '10px 12px', background: '#F0FDFA', borderRadius: 10 }}>
                    ...
                    <div style={{ fontSize: '0.72rem', color: '#64748B', lineHeight: 1.5 }}>A catch-all when you don&apos;t qualify for innocent or injured spouse. Available when it would be inequitable to hold you liable. Filed via Form 8857.</div>
                  </div>
                </div>

                {/* Key Differences Table */}
                <div style={{ fontSize: '0.68rem', fontWeight: 700, color: '#CBD5E1', textTransform: 'uppercase', letterSpacing: '0.06em', marginBottom: 8 }}>Key Differences</div>
                <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                  <thead>
                    <tr>
                      <th style={{ width: '28%', fontSize: '0.62rem', fontWeight: 700, color: '#94A3B8', textTransform: 'uppercase', letterSpacing: '0.06em', padding: '8px 6px', textAlign: 'left', borderBottom: '1px solid #F1F5F9' }} />
                      <th style={{ width: '36%', fontSize: '0.62rem', fontWeight: 700, color: '#94A3B8', textTransform: 'uppercase', letterSpacing: '0.06em', padding: '8px 6px', textAlign: 'left', borderBottom: '1px solid #F1F5F9' }}>Innocent</th>
                      <th style={{ width: '36%', fontSize: '0.62rem', fontWeight: 700, color: '#94A3B8', textTransform: 'uppercase', letterSpacing: '0.06em', padding: '8px 6px', textAlign: 'left', borderBottom: '1px solid #F1F5F9' }}>Injured</th>
                    </tr>
                  </thead>
                  <tbody>
                    {DIFF_ROWS.map((row, i) => (
                      <tr key={row.label}>
                        <td style={{ fontWeight: 600, color: '#0A1628', fontSize: '0.72rem', padding: '8px 6px', borderBottom: i === DIFF_ROWS.length - 1 ? 'none' : '1px solid #F8FAFC', verticalAlign: 'top', lineHeight: 1.4 }}>{row.label}</td>
                        <td style={{ fontSize: '0.72rem', color: '#64748B', padding: '8px 6px', borderBottom: i === DIFF_ROWS.length - 1 ? 'none' : '1px solid #F8FAFC', verticalAlign: 'top', lineHeight: 1.4 }}>{row.innocent}</td>
                        <td style={{ fontSize: '0.72rem', color: '#64748B', padding: '8px 6px', borderBottom: i === DIFF_ROWS.length - 1 ? 'none' : '1px solid #F8FAFC', verticalAlign: 'top', lineHeight: 1.4 }}>{row.injured}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
          ...
          {/* Not sure? CTA */}
          <div style={{ background: 'linear-gradient(135deg, #0A1628 0%, #1E3A5F 100%)', borderRadius: 16, padding: 20, textAlign: 'center' }}>
