      ...
      <div style={{ maxWidth: '28rem', margin: '0 auto' }}>
        <div style={{ display: 'flex', flexDirection: 'column', gap: 16, padding: '8px 20px 40px' }}>
          ...
          <div style={{ textAlign: 'center', padding: '0 10px' }}>
            <div style={{ width: 56, height: 56, borderRadius: 18, background: '#1A1A2E', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 14px' }}>
              <i className="fas fa-crown" style={{ fontSize: 22, color: 'white' }} />
            </div>
            <h1 style={{ fontSize: '1.5rem', fontWeight: 800, color: '#1A1A2E', letterSpacing: '-0.01em', marginBottom: 6, marginTop: 0 }}>Unlock Full Access</h1>
            <p style={{ fontSize: '0.84rem', color: '#8585A0', fontWeight: 400, lineHeight: 1.5, margin: 0 }}>Choose the plan that fits your needs</p>
          </div>

          {/* Plans */}
          <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
            {/* Free Plan */}
            <div style={{ background: '#FAFAFF', border: '1.5px solid #D5D5E0', borderRadius: 16, padding: 18, position: 'relative', overflow: 'hidden' }}>
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 10 }}>
                ...
                <span style={{ padding: '3px 10px', background: '#D5D5E0', borderRadius: 9999, fontSize: '0.65rem', fontWeight: 600, color: '#5C5C7A' }}>Current Plan</span>
              </div>
            ...
            {/* Starter Plan */}
            <div style={{ background: 'white', border: '1.5px solid #D5D5E0', borderRadius: 16, padding: 18, position: 'relative', overflow: 'hidden', cursor: 'pointer' }}>
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 10 }}>
                <div>
            ...
            <div style={{ background: 'white', border: '2px solid transparent', borderRadius: 16, padding: 20, position: 'relative', overflow: 'hidden', cursor: 'pointer' }}>
              ...
              <div style={{ position: 'absolute', top: 0, right: 16 }}>
                <div style={{ padding: '4px 12px', background: '#1A1A2E', borderRadius: '0 0 10px 10px', fontSize: '0.65rem', fontWeight: 700, color: 'white', textTransform: 'uppercase', letterSpacing: '0.04em' }}>Most Popular</div>
              </div>

              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 12, marginTop: 4 }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
                  <span style={{ fontSize: '1.05rem', fontWeight: 800, color: '#1A1A2E' }}>Pro</span>
                  <span style={{ padding: '3px 8px', background: '#EFF4FF', borderRadius: 9999, fontSize: '0.6rem', fontWeight: 700, color: '#1A1A2E', textTransform: 'uppercase', letterSpacing: '0.04em' }}>Recommended</span>
                </div>
                <div>
                  <span style={{ fontSize: '1.4rem', fontWeight: 900, color: '#1A1A2E' }}>$49</span>
                  <span style={{ fontSize: '0.78rem', color: '#8585A0', fontWeight: 400 }}>/mo</span>
                </div>
              </div>
              <div style={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
                {['Everything in Starter', 'Expert consultation included', 'IRS representation', 'Priority support'].map((f) => (
                  <div key={f} style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '4px 0' }}>
                    <i className="fas fa-check-circle" style={{ fontSize: 12, color: '#1A1A2E' }} />
          ...
          <div style={{ textAlign: 'center' }}>
            <a href="#" style={{ fontSize: '0.82rem', fontWeight: 600, color: '#8585A0', display: 'inline-flex', alignItems: 'center', gap: 5, textDecoration: 'none' }}>
              Compare all features
