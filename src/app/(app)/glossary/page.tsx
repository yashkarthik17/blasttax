...
const glossaryTerms: GlossaryTerm[] = [
  { abbreviation: 'AC', name: 'Activity Code', definition: 'An internal IRS code that categorizes the type of activity or action taken on a taxpayer\'s account, such as audits, collections, or adjustments.', letter: 'A', color: '#1A1A2E', bgColor: '#EFF4FF', usedIn: ['Case Detail', 'Analysis Results'] },
  ...
  { abbreviation: 'OIC', name: 'Offer in Compromise', definition: 'An agreement between a taxpayer and the IRS that settles tax debt for less than the full amount owed. The IRS evaluates your ability to pay, income, expenses, and asset equity. The application fee is $205.', letter: 'O', color: '#1A1A2E', bgColor: '#EFF4FF', usedIn: ['Resolution Center', 'Analysis Results', 'Dashboard', 'OIC Form Builder'] },
  ...
  { abbreviation: 'TC', name: 'Transaction Code', definition: 'Three-digit codes on IRS account transcripts that describe specific actions taken on your account (e.g., TC 150 = return filed, TC 290 = additional tax assessed, TC 971 = notice issued).', letter: 'T', color: '#5C5C7A', bgColor: '#F0F0F5', usedIn: ['Case Detail', 'Transcript Analysis'] },
    ...
    <div style={{ minHeight: '100vh', background: '#FAFAFF' }}>
      <div style={{ maxWidth: '28rem', margin: '0 auto' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '14px 20px 12px' }}>
          ...
          <span style={{ flex: 1, fontSize: '0.95rem', fontWeight: 800, color: '#1A1A2E', textAlign: 'center' }}>IRS Terms Glossary</span>
          <div style={{ width: 40 }} />
        </div>
            ...
            {letters.map((letter) => (
              <div
                ...
                style={{
                  ...
                  fontSize: '0.72rem',
                  fontWeight: 700,
                  color: activeLetter === letter ? 'white' : '#8585A0',
                  background: activeLetter === letter ? '#1A1A2E' : 'transparent',
                  cursor: 'pointer',
                  flexShrink: 0,
                }}
              >
                ...
                >
                  ...
                  >
                    <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                      ...
                      <span style={{ fontSize: '0.85rem', fontWeight: 600, color: '#1A1A2E', lineHeight: 1.4 }}>{term.name}</span>
                    </div>
                  ...
                  {isOpen && (
                    <div style={{ padding: '0 16px 14px' }}>
                      <p style={{ fontSize: '0.82rem', color: '#5C5C7A', lineHeight: 1.6, marginBottom: 8, marginTop: 0 }}>{term.definition}</p>
