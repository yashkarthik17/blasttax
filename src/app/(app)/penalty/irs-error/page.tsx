  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC]">
      ...
      <div className="flex items-center justify-between px-5 py-3.5">
        ...
        <div className="flex-1 text-center text-[0.95rem] font-extrabold text-[#0A1628]">IRS Error Relief</div>
      ...
      <div className="flex flex-col gap-3.5 px-5 pb-8">
        ...
        <div className="rounded-2xl border border-[#E2E8F0] bg-white overflow-hidden shadow-[0_1px_2px_rgba(0,0,0,0.03)]">
          <div className="h-[3px] bg-[#0A1628]" />
          <div className="p-4">
            <div className="flex items-center gap-2.5 mb-3">
              <div className="flex h-9 w-9 items-center justify-center rounded-[10px] bg-[#EBF0FF]">
                <svg className="h-4 w-4 text-[#0A1628]" fill="currentColor" viewBox="0 0 24 24"><path d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z"/></svg>
              </div>
              <div>
                <div className="text-[0.88rem] font-extrabold text-[#0A1628]">Written IRS Advice</div>
                <div className="text-[0.68rem] text-[#94A3B8] mt-px">IRC &sect; 6404(f)</div>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-2">
              {[
                ...
                <div key={item} className="flex items-start gap-2">
                  <div className="w-[5px] h-[5px] rounded-full bg-[#0A1628] mt-1.5 shrink-0" />
                  <span className="text-[0.75rem] text-[#64748B] leading-relaxed">{item}</span>
                </div>
              ))}
            </div>
          </div>
        ...
        <div className="rounded-2xl border border-[#E2E8F0] bg-white overflow-hidden shadow-[0_1px_2px_rgba(0,0,0,0.03)]">
          ...
          <div className="p-4">
            <div className="flex items-center gap-2.5 mb-3">
              ...
              <div>
                <div className="text-[0.88rem] font-extrabold text-[#0A1628]">IRS Processing Error</div>
                <div className="text-[0.68rem] text-[#94A3B8] mt-px">System / Clerical Mistakes</div>
              </div>
            </div>
        ...
        <div className="rounded-[18px] border border-[#E2E8F0] bg-white p-[18px] shadow-[0_1px_2px_rgba(0,0,0,0.03)]">
          <div className="flex items-center gap-2 mb-3.5">
            <div className="flex h-[30px] w-[30px] items-center justify-center rounded-lg bg-[#EBF0FF]">
              <svg className="h-3 w-3 text-[#0A1628]" fill="currentColor" viewBox="0 0 24 24"><path d="M2 17h2v.5H3v1h1v.5H2v1h3v-4H2v1zm1-9h1V4H2v1h1v3zm-1 3h1.8L2 13.1v.9h3v-1H3.2L5 10.9V10H2v1zm5-6v2h14V5H7zm0 14h14v-2H7v2zm0-6h14v-2H7v2z"/></svg>
            </div>
            <span className="text-[0.85rem] font-bold text-[#0A1628]">How to Request</span>
          </div>

          {HOW_TO_REQUEST.map((step, index) => (
            <div key={step.title} className={`flex items-start gap-3 py-3 ${index < HOW_TO_REQUEST.length - 1 ? 'border-b border-[#F1F5F9]' : ''}`}>
