  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC]">
      ...
      <div className="flex items-center justify-between px-5 py-3.5">
        ...
        <div className="flex-1 text-center text-[0.95rem] font-extrabold text-[#0A1628]">Administrative Waiver</div>
      ...
      <div className="flex flex-col gap-3.5 px-5 pb-8">
        ...
        <div className="rounded-[18px] border border-[#E2E8F0] bg-white p-[18px] shadow-[0_1px_2px_rgba(0,0,0,0.03)]">
          <div className="text-[0.7rem] font-bold text-[#CBD5E1] uppercase tracking-wider mb-3.5">How It Works</div>
          ...
          {PROCESS_STEPS.map((step, index) => (
            <div key={step.title} className="flex gap-3 relative pb-4">
              ...
              <div className="flex-1 pt-1">
                ...
                <div className="text-[0.72rem] text-[#94A3B8] mt-0.5 leading-relaxed">{step.description}</div>
              </div>
            </div>
          ))}
        </div>
        ...
        {/* Waiver Card 1 */}
        <div className="rounded-[14px] border border-[#E2E8F0] bg-white p-3.5 shadow-[0_1px_2px_rgba(0,0,0,0.03)]">
          <div className="flex items-center gap-2 mb-2.5">
            <span className="rounded-lg bg-[#EBF0FF] px-2.5 py-0.5 text-[0.65rem] font-extrabold text-[#0A1628]">2024</span>
            <span className="text-[0.82rem] font-bold text-[#0A1628]">COVID-era Penalty Relief</span>
          </div>
          <p className="text-[0.75rem] text-[#64748B] leading-relaxed mb-2">
          ...
          <div className="flex items-center gap-1.5">
            ...
            <span className="text-[0.7rem] text-[#94A3B8] font-medium">Tax years 2020 &ndash; 2021</span>
          </div>
        </div>
        ...
        <div className="rounded-[14px] border border-[#E2E8F0] bg-white p-3.5 shadow-[0_1px_2px_rgba(0,0,0,0.03)]">
          <div className="flex items-center gap-2 mb-2.5">
            ...
            <span className="text-[0.82rem] font-bold text-[#0A1628]">Notice CP14 Processing Delays</span>
          </div>
          <p className="text-[0.75rem] text-[#64748B] leading-relaxed mb-2">
          ...
          <div className="flex items-center gap-1.5">
            <svg className="h-2.5 w-2.5 text-[#00A651]" fill="currentColor" viewBox="0 0 24 24"><path d="M19 3h-1V1h-2v2H8V1H6v2H5c-1.11 0-1.99.9-1.99 2L3 19c0 1.1.89 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 16H5V8h14v11zM9 10H7v2h2v-2zm4 0h-2v2h2v-2zm4 0h-2v2h2v-2z"/></svg>
            <span className="text-[0.7rem] text-[#94A3B8] font-medium">Affected CP14 recipients</span>
          </div>
        </div>
        ...
        <div className="rounded-[18px] border border-[#E2E8F0] bg-white p-[18px] shadow-[0_1px_2px_rgba(0,0,0,0.03)]">
          <div className="flex items-center gap-2 mb-3.5">
            ...
            <span className="text-[0.85rem] font-bold text-[#0A1628]">How to Check If You Qualify</span>
          </div>

          {HOW_STEPS.map((step, index) => (
            <div key={step.title} className={`flex items-start gap-3 py-2.5 ${index < HOW_STEPS.length - 1 ? 'border-b border-[#F1F5F9]' : ''}`}>
