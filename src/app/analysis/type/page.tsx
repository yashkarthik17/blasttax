    ...
    <div style={{ minHeight: '100vh', background: '#FAFAFF' }}>
      <div style={{ maxWidth: '480px', margin: '0 auto' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '16px 20px 8px' }}>
          ...
          <span style={{ fontSize: 15, fontWeight: 600, color: '#1A1A2E' }}>New Analysis</span>
          <div style={{ width: 40 }} />
        </div>
        ...
        <div style={{ padding: '0 20px 24px', display: 'flex', flexDirection: 'column', gap: 0 }}>
          ...
          <div style={{ padding: '4px 0 20px' }}>
            <h1 style={{ fontSize: '1.5rem', fontWeight: 800, color: '#1A1A2E', lineHeight: 1.2, letterSpacing: '-0.01em', marginBottom: 6 }}>
              What type of tax debt?
            </h1>
            <p style={{ fontSize: 13, color: '#8585A0', margin: 0 }}>
          ...
          <div>
            ...
            <button
              ...
              style={{
                ...
                border: `2px solid ${selectedEntity === 'individual' ? '#2563EB' : '#F0F0F5'}`,
            ...
            >
              <div style={{
                ...
                justifyContent: 'center', fontSize: 22, flexShrink: 0, color: 'white', background: '#1A1A2E',
              }}>
                <i className="fa-solid fa-user" />
              </div>
              <div style={{ flex: 1, paddingRight: 8 }}>
                <div style={{ fontSize: 15, fontWeight: 700, color: '#1A1A2E', marginBottom: 3 }}>Individual (1040)</div>
                <div style={{ fontSize: 13, color: '#8585A0', lineHeight: 1.4 }}>Personal income tax debt</div>
              </div>
              <div style={{
                width: 22, height: 22, border: `2px solid ${selectedEntity === 'individual' ? '#2563EB' : '#F0F0F5'}`,
              ...
              {/* Most Common badge */}
              <div style={{
                position: 'absolute', top: -1, right: 16, background: '#1A1A2E', color: 'white',
            ...
            <button
              ...
              style={{
                ...
                border: `2px solid ${selectedEntity === 'business' ? '#2563EB' : '#F0F0F5'}`,
                borderRadius: 16, cursor: 'pointer', width: '100%', textAlign: 'left',
                marginTop: 10,
            ...
            >
              ...
              <div style={{ flex: 1 }}>
                <div style={{ fontSize: 15, fontWeight: 700, color: '#1A1A2E', marginBottom: 3 }}>Business (941/940)</div>
                <div style={{ fontSize: 13, color: '#8585A0', lineHeight: 1.4 }}>Payroll tax / employment tax</div>
              </div>
              <div style={{
                width: 22, height: 22, border: `2px solid ${selectedEntity === 'business' ? '#2563EB' : '#F0F0F5'}`,
                borderRadius: '50%', flexShrink: 0, display: 'flex', alignItems: 'center', justifyContent: 'center',
            ...
            <button
              ...
              style={{
                ...
                border: `2px solid ${selectedEntity === 'both' ? '#2563EB' : '#F0F0F5'}`,
                borderRadius: 16, cursor: 'pointer', width: '100%', textAlign: 'left',
                marginTop: 10,
            ...
            >
              ...
              <div style={{ flex: 1 }}>
                <div style={{ fontSize: 15, fontWeight: 700, color: '#1A1A2E', marginBottom: 3 }}>Both Individual & Business</div>
                <div style={{ fontSize: 13, color: '#8585A0', lineHeight: 1.4 }}>I have both types of debt</div>
              </div>
              <div style={{
                width: 22, height: 22, border: `2px solid ${selectedEntity === 'both' ? '#2563EB' : '#F0F0F5'}`,
                borderRadius: '50%', flexShrink: 0, display: 'flex', alignItems: 'center', justifyContent: 'center',
          ...
          <div style={{
            ...
            <div style={{ marginBottom: 14 }}>
              <div style={{ fontSize: 13, fontWeight: 700, color: '#B0B0C8', textTransform: 'uppercase' as const, letterSpacing: '0.06em' }}>
                Analysis Depth
              </div>
            </div>
            ...
            <button
              ...
              style={{
                ...
                border: `1.5px solid ${selectedDepth === 'full' ? '#2563EB' : '#F0F0F5'}`,
            ...
            >
              <div style={{ width: 40, height: 40, borderRadius: 12, display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 16, flexShrink: 0, background: '#EFF4FF', color: '#1A1A2E' }}>
                <i className="fa-solid fa-compass" />
              </div>
              <div style={{ flex: 1 }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginBottom: 2 }}>
                  <span style={{ fontSize: 14, fontWeight: 700, color: '#1A1A2E' }}>Full Resolution Analysis</span>
                  <span style={{
                ...
                <div style={{ fontSize: 12, color: '#8585A0', lineHeight: 1.4 }}>Complete assessment of all 13+ resolution options</div>
              </div>
              <div style={{
                width: 20, height: 20, border: `2px solid ${selectedDepth === 'full' ? '#2563EB' : '#F0F0F5'}`,
                borderRadius: '50%', flexShrink: 0, display: 'flex', alignItems: 'center', justifyContent: 'center',
            ...
            <button
              ...
              style={{
                ...
                border: `1.5px solid ${selectedDepth === 'quick' ? '#2563EB' : '#F0F0F5'}`,
                borderRadius: 14, cursor: 'pointer', width: '100%', textAlign: 'left',
                marginBottom: 10,
            ...
            >
              ...
              <div style={{ flex: 1 }}>
                <div style={{ fontSize: 14, fontWeight: 700, color: '#1A1A2E', marginBottom: 2 }}>Quick Eligibility Check</div>
                <div style={{ fontSize: 12, color: '#8585A0', lineHeight: 1.4 }}>Fast screening for common resolution types</div>
              </div>
              <div style={{
                width: 20, height: 20, border: `2px solid ${selectedDepth === 'quick' ? '#2563EB' : '#F0F0F5'}`,
                borderRadius: '50%', flexShrink: 0, display: 'flex', alignItems: 'center', justifyContent: 'center',
            ...
            <button
              ...
              style={{
                ...
                border: `1.5px solid ${selectedDepth === 'penalty' ? '#2563EB' : '#F0F0F5'}`,
                borderRadius: 14, cursor: 'pointer', width: '100%', textAlign: 'left',
                marginBottom: 10,
            ...
            >
              ...
              <div style={{ flex: 1 }}>
                <div style={{ fontSize: 14, fontWeight: 700, color: '#1A1A2E', marginBottom: 2 }}>Penalty Review Only</div>
                <div style={{ fontSize: 12, color: '#8585A0', lineHeight: 1.4 }}>Check penalty abatement eligibility</div>
              </div>
              <div style={{
                width: 20, height: 20, border: `2px solid ${selectedDepth === 'penalty' ? '#2563EB' : '#F0F0F5'}`,
                borderRadius: '50%', flexShrink: 0, display: 'flex', alignItems: 'center', justifyContent: 'center',
            ...
            <button
              ...
              style={{
                ...
                border: `1.5px solid ${selectedDepth === 'csed' ? '#2563EB' : '#F0F0F5'}`,
                borderRadius: 14, cursor: 'pointer', width: '100%', textAlign: 'left',
                marginBottom: 10,
            ...
            >
              ...
              <div style={{ flex: 1 }}>
                <div style={{ fontSize: 14, fontWeight: 700, color: '#1A1A2E', marginBottom: 2 }}>CSED Calculator</div>
                <div style={{ fontSize: 12, color: '#8585A0', lineHeight: 1.4 }}>Calculate when your debts expire</div>
              </div>
              <div style={{
                width: 20, height: 20, border: `2px solid ${selectedDepth === 'csed' ? '#2563EB' : '#F0F0F5'}`,
                borderRadius: '50%', flexShrink: 0, display: 'flex', alignItems: 'center', justifyContent: 'center',
          ...
          <button
            ...
            style={{
              ...
              background: canContinue ? '#00A651' : '#D5D5E0',
              color: canContinue ? 'white' : '#B0B0C8',
