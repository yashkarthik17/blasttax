        ...
        <div className="space-y-6">
          ...
          {amount > 0 && (
            <div className="rounded-xl border border-red-500/30 bg-red-500/10 p-5 text-center">
              <p className="text-sm text-zinc-400">Personal TFRP Liability</p>
          ...
          {/* Defense Options */}
          <div className="rounded-xl border border-zinc-800 bg-zinc-900 p-5">
            <p className="mb-4 font-medium text-white">Defense Options</p>
          ...
          {/* Resolution Routing */}
          <div className="rounded-xl border border-zinc-800 bg-zinc-900 p-5">
            <p className="mb-4 font-medium text-white">Resolution Routing</p>
