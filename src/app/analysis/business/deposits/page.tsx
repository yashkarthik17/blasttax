      ...
      <div style={{ maxWidth: '28rem', margin: '0 auto' }}>
        ...
        <div style={{ padding: '16px 20px 20px' }}>
          <div style={{ marginBottom: '6px' }}>
            <h1 style={{ fontSize: '1.3rem', fontWeight: 800, color: '#1A1A2E', lineHeight: 1.25 }}>Deposit Compliance</h1>
            <p style={{ fontSize: '13px', color: '#8585A0', marginTop: '4px', lineHeight: 1.5 }}>Operating businesses must be current on federal tax deposits.</p>
          </div>
          ...
          <div style={{ background: 'white', border: '1px solid #F0F0F5', borderRadius: '16px', padding: '16px', marginBottom: '12px' }}>
            ...
            <label style={{ display: 'flex', alignItems: 'center', gap: '8px', marginTop: '10px', cursor: 'pointer' }}>
              ...
              />
              <span style={{ fontSize: '12px', fontWeight: 500, color: '#5C5C7A' }}>Enrolled in EFTPS (Electronic Federal Tax Payment System)?</span>
            </label>
            <div style={{ fontSize: '10.5px', color: '#5C5C7A', marginTop: '8px', padding: '8px', background: '#FAFAFF', borderRadius: '8px' }}>If not enrolled, enroll at EFTPS.gov. PIN arrives by mail in 5-7 business days.</div>
          </div>
            ...
            <div style={{ display: 'flex', gap: '8px' }}>
              <div
                ...
                style={{
                  ...
                  background: schedule === 'monthly' ? '#EFF4FF' : '#FAFAFF',
                  border: schedule === 'monthly' ? '1.5px solid #2563EB' : '1.5px solid #F0F0F5',
                  borderRadius: '8px', fontSize: '12px', fontWeight: 600,
                  color: schedule === 'monthly' ? '#2563EB' : '#5C5C7A', cursor: 'pointer', transition: 'all 0.2s ease',
                }}
              >Monthly</div>
              <div
                ...
                style={{
                  flex: 1, justifyContent: 'center', padding: '10px', display: 'inline-flex', alignItems: 'center',
                  background: schedule === 'semiweekly' ? '#EFF4FF' : '#FAFAFF',
                  border: schedule === 'semiweekly' ? '1.5px solid #2563EB' : '1.5px solid #F0F0F5',
                  borderRadius: '8px', fontSize: '12px', fontWeight: 600,
                  color: schedule === 'semiweekly' ? '#2563EB' : '#5C5C7A', cursor: 'pointer', transition: 'all 0.2s ease',
                }}
              >Semi-Weekly</div>
            </div>
            <div style={{ fontSize: '10.5px', color: '#5C5C7A', marginTop: '8px', padding: '8px', background: '#FAFAFF', borderRadius: '8px' }}>Based on lookback period: If total 941 tax &gt; $50,000 (Jul 1 - Jun 30 two years prior), semi-weekly depositor.</div>
          </div>
            ...
            <table style={{ width: '100%', fontSize: '12px', borderCollapse: 'collapse' as const }}>
              <thead>
                <tr style={{ background: '#FAFAFF' }}>
                  <th style={{ padding: '8px', textAlign: 'left' as const, fontWeight: 600, color: '#8585A0' }}>Date</th>
                  <th style={{ padding: '8px', textAlign: 'right' as const, fontWeight: 600, color: '#8585A0' }}>Amount</th>
                  <th style={{ padding: '8px', textAlign: 'center' as const, fontWeight: 600, color: '#8585A0' }}>Status</th>
                </tr>
              </thead>
              <tbody>
                {DEPOSIT_DATA.map((d, i) => (
                  <tr key={i} style={{ borderBottom: i < DEPOSIT_DATA.length - 1 ? '1px solid #F0F0F5' : 'none' }}>
          ...
          <div style={{ background: 'white', border: '1px solid #F0F0F5', borderRadius: '16px', padding: '16px', marginBottom: '12px' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
              ...
              <div>
                <span style={{ fontSize: '13px', fontWeight: 700, color: '#1A1A2E' }}>$100,000 Next-Day Rule</span>
                <p style={{ fontSize: '11.5px', color: '#5C5C7A', marginTop: '2px' }}>If accumulated tax reaches $100,000+ on any day, deposit must be made by the next business day (IRC 6302).</p>
              </div>
            </div>
            <label style={{ display: 'flex', alignItems: 'center', gap: '8px', marginTop: '10px', cursor: 'pointer' }}>
              <input
              ...
              />
              <span style={{ fontSize: '12px', fontWeight: 500, color: '#5C5C7A' }}>$100,000 next-day rule applies?</span>
            </label>
          </div>
