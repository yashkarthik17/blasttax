    ...
    <div className="min-h-screen bg-[#FAFAFF]">
      <div className="mx-auto max-w-md md:max-w-2xl lg:max-w-4xl">
        ...
        <div style={{ display: 'flex', alignItems: 'center', padding: '14px 20px' }}>
          ...
          <span style={{ flex: 1, textAlign: 'center', fontSize: '0.95rem', fontWeight: 800, color: '#1A1A2E' }}>Can I Combine?</span>
          <div style={{ width: 40 }} />
        </div>

        <div style={{ padding: '0 20px 20px' }}>
          {/* Title */}
          <h1 style={{ fontSize: '1.25rem', fontWeight: 800, color: '#1A1A2E', lineHeight: 1.25, marginBottom: 4 }}>Resolution Compatibility</h1>
          <p style={{ fontSize: '0.8125rem', color: '#5C5C7A', marginBottom: 22 }}>Not all resolutions can run together</p>
          ...
          <div style={{ marginBottom: 16 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 10, marginTop: 4 }}>
              ...
              <span style={{ fontSize: '0.6875rem', color: '#8585A0', fontWeight: 500 }}>Can coexist</span>
            </div>
            <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
              {SIMULTANEOUS.map((item) => (
                <div key={item} style={{ display: 'flex', alignItems: 'center', gap: 12, padding: '11px 14px', background: 'white', border: '1px solid #F0F0F5', borderRadius: 12, transition: 'all 0.3s' }}>
                  ...
                  <p style={{ fontSize: '0.8125rem', fontWeight: 600, color: '#1A1A2E', margin: 0 }}>{item}</p>
                </div>
              ))}
            </div>
          </div>
          ...
          <div style={{ marginBottom: 16 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 10, marginTop: 4 }}>
              ...
              <span style={{ fontSize: '0.6875rem', color: '#8585A0', fontWeight: 500 }}>Cannot coexist</span>
            </div>
            <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
              {EXCLUSIVE.map((item) => (
                <div key={item.combo} style={{ display: 'flex', alignItems: 'center', gap: 12, padding: '11px 14px', background: 'white', border: '1px solid rgba(230,57,70,0.12)', borderRadius: 12 }}>
                  ...
                  <div style={{ flex: 1 }}>
                    <p style={{ fontSize: '0.8125rem', fontWeight: 600, color: '#1A1A2E', margin: 0 }}>{item.combo}</p>
                    <p style={{ fontSize: '0.6875rem', color: '#8585A0', margin: 0 }}>{item.reason}</p>
                  </div>
                </div>
              ))}
            </div>
          ...
          <div style={{ marginBottom: 16 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 10, marginTop: 4 }}>
              ...
              <span style={{ fontSize: '0.6875rem', color: '#8585A0', fontWeight: 500 }}>Do one, then the other</span>
            </div>
            <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
              {SEQUENTIAL.map((item) => (
                <div key={item.combo} style={{ display: 'flex', alignItems: 'center', gap: 12, padding: '11px 14px', background: 'white', border: '1px solid rgba(37,99,235,0.12)', borderRadius: 12 }}>
                  ...
                  <div style={{ flex: 1 }}>
                    <p style={{ fontSize: '0.8125rem', fontWeight: 600, color: '#1A1A2E', margin: 0 }}>
                      {item.combo} <i className="fa-solid fa-arrow-right" style={{ fontSize: 9, color: '#B0B0C8', margin: '0 2px' }} /> {item.target}
                    </p>
                    <p style={{ fontSize: '0.6875rem', color: '#8585A0', margin: 0 }}>{item.reason}</p>
                  </div>
                </div>
          ...
          <div style={{ marginBottom: 16 }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
              {SPECIAL.map((item) => (
                <div key={item.text} style={{ padding: 14, background: 'white', border: '1px solid #F0F0F5', borderRadius: 14, display: 'flex', alignItems: 'flex-start', gap: 10 }}>
                  ...
                  <div>
                    <p style={{ fontSize: '0.8125rem', fontWeight: 600, color: '#1A1A2E', margin: 0 }}>{item.text}</p>
                    <p style={{ fontSize: '0.6875rem', color: '#8585A0', margin: '2px 0 0' }}>{item.detail}</p>
                  </div>
                </div>
              ))}
            </div>
          ...
          <div style={{ marginTop: 20, textAlign: 'center' }}>
            <Link href="/analysis/strategic-plays" style={{ fontSize: '0.8125rem', fontWeight: 600, color: '#5C5C7A', textDecoration: 'none' }}>
