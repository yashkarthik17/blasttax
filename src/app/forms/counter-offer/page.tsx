  ...
  return (
    <div className="mx-auto max-w-2xl space-y-5">
      ...
      <div className="text-center">
        <h1 className="text-2xl font-extrabold text-[#0A1628]">The IRS Has Responded</h1>
      ...
      <div className="rounded-2xl border border-[#F1F5F9] bg-white p-5">
        <div className="flex items-center justify-between pb-4">
          <span className="text-sm font-semibold text-[#64748B]">Your Offer</span>
          <span className="text-lg font-bold text-[#94A3B8]">${yourOffer.toLocaleString()}</span>
        </div>
        ...
        <div className="flex items-center justify-between py-4">
          <span className="text-sm font-semibold text-[#64748B]">IRS Counter</span>
        ...
        <div className="flex items-center justify-between border-t border-[#F1F5F9] pt-3">
          <span className="text-sm font-semibold text-[#64748B]">Difference</span>
      ...
      <div className="rounded-2xl border border-[#F1F5F9] bg-white overflow-hidden">
        ...
        >
          <span className="text-sm font-bold text-[#0A1628]">Why the Difference?</span>
          <svg
      ...
      <div className="rounded-2xl border border-emerald-500/20 bg-white p-4">
        <div className="mb-4 flex items-start gap-3">
          ...
          <div>
            <div className="text-sm font-bold text-[#0A1628]">Accept Counter-Offer</div>
            <div className="mt-1 text-xs text-[#64748B] leading-relaxed">
      ...
      <div className="rounded-2xl border border-blue-500/20 bg-white p-4">
        <div className="mb-4 flex items-start gap-3">
          ...
          <div>
            <div className="text-sm font-bold text-[#0A1628]">Negotiate Further</div>
            <div className="mt-1 text-xs text-[#64748B] leading-relaxed">
      ...
      <div className="rounded-2xl border border-red-500/20 bg-white p-4">
        <div className="mb-4 flex items-start gap-3">
          ...
          <div>
            <div className="text-sm font-bold text-[#0A1628]">Reject &amp; Appeal</div>
            <div className="mt-1 text-xs text-[#64748B] leading-relaxed">
