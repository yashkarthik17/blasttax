  ...
  return (
    <div className="mx-auto max-w-2xl space-y-5">
      ...
      <div className="text-center">
        <h1 className="text-2xl font-extrabold text-[#1A1A2E]">The IRS Has Responded</h1>
      ...
      {/* Comparison Card */}
      <div className="rounded-2xl border border-[#F0F0F5] bg-white p-5">
        <div className="flex items-center justify-between pb-4">
          <span className="text-sm font-semibold text-[#5C5C7A]">Your Offer</span>
          <span className="text-lg font-bold text-[#8585A0]">${yourOffer.toLocaleString()}</span>
        </div>
        ...
        <div className="flex items-center justify-between py-4">
          <span className="text-sm font-semibold text-[#5C5C7A]">IRS Counter</span>
        ...
        <div className="flex items-center justify-between border-t border-[#F0F0F5] pt-3">
          <span className="text-sm font-semibold text-[#5C5C7A]">Difference</span>
          <span className="text-base font-bold text-[#E63946]">+${difference.toLocaleString()}</span>
        </div>
      </div>
      ...
      <div className="rounded-2xl border border-[#F0F0F5] bg-white overflow-hidden">
        ...
        >
          <span className="text-sm font-bold text-[#1A1A2E]">Why the Difference?</span>
          <svg
            className={`h-3.5 w-3.5 text-[#8585A0] transition-transform ${expanded ? 'rotate-180' : ''}`}
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
            strokeWidth={2.5}
      ...
      <div className="rounded-2xl border border-emerald-500/20 bg-white p-4">
        <div className="mb-4 flex items-start gap-3">
          <div className="flex h-11 w-11 flex-shrink-0 items-center justify-center rounded-xl bg-[#00A651]/15">
            <svg className="h-5 w-5 text-[#00A651]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
              <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" />
            </svg>
          </div>
          <div>
            <div className="text-sm font-bold text-[#1A1A2E]">Accept Counter-Offer</div>
            <div className="mt-1 text-xs text-[#5C5C7A] leading-relaxed">
              Agree to pay $14,200. Case moves to payment processing.
            </div>
          </div>
        </div>
        <button className="w-full rounded-full bg-[#00A651] py-3 text-sm font-bold text-white transition-all hover:bg-[#008C44] active:scale-[0.98]">
          Accept ${irsCounter.toLocaleString()}
        </button>
      </div>

      {/* Action Option 2: Negotiate */}
      <div className="rounded-2xl border border-blue-500/20 bg-white p-4">
        <div className="mb-4 flex items-start gap-3">
          <div className="flex h-11 w-11 flex-shrink-0 items-center justify-center rounded-xl bg-[#2563EB]/15">
          ...
          <div>
            <div className="text-sm font-bold text-[#1A1A2E]">Negotiate Further</div>
            <div className="mt-1 text-xs text-[#5C5C7A] leading-relaxed">
              Submit a revised offer with additional documentation supporting a lower amount.
            </div>
          </div>
        </div>
        <button className="w-full rounded-full bg-[#2563EB] py-3 text-sm font-bold text-white transition-all hover:bg-[#1D4ED8] active:scale-[0.98]">
          Submit Revised Offer
        </button>
      </div>

      {/* Action Option 3: Reject & Appeal */}
      <div className="rounded-2xl border border-red-500/20 bg-white p-4">
        <div className="mb-4 flex items-start gap-3">
          <div className="flex h-11 w-11 flex-shrink-0 items-center justify-center rounded-xl bg-red-500/15">
            <svg className="h-5 w-5 text-[#E63946]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
              <path strokeLinecap="round" strokeLinejoin="round" d="M6 18L18 6M6 6l12 12" />
            </svg>
          </div>
          <div>
            <div className="text-sm font-bold text-[#1A1A2E]">Reject &amp; Appeal</div>
            <div className="mt-1 text-xs text-[#5C5C7A] leading-relaxed">
              Decline the counter and file an appeal within 30 days using Form 13711.
            </div>
          </div>
        </div>
        <button className="w-full rounded-full border border-red-500 bg-transparent py-3 text-sm font-bold text-[#E63946] transition-all hover:bg-red-500/10 active:scale-[0.98]">
          File Appeal
        </button>
      </div>
