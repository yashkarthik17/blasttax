...
export default function Form433APage() {
  ...
  return (
    <div className="mx-auto max-w-2xl space-y-4">
      ...
      {/* Info Banner */}
      <div className="flex items-start gap-3 rounded-xl bg-[#2563EB]/10 px-4 py-3 ring-1 ring-blue-500/20">
      ...
      <Section
        icon={<svg className="h-3.5 w-3.5 text-[#2563EB]" fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" clipRule="evenodd" /></svg>}
        iconBg="bg-[#2563EB]/15"
        title="Section 1: Personal Information"
        subtitle="Pre-filled from profile"
        badge="COMPLETE"
        badgeColor="bg-[#00A651]/15 text-[#00A651]"
      >
      ...
      <Section
        icon={<svg className="h-3.5 w-3.5 text-[#00A651]" fill="currentColor" viewBox="0 0 20 20"><path d="M4 4a2 2 0 00-2 2v1h16V6a2 2 0 00-2-2H4z" /><path fillRule="evenodd" d="M18 9H2v5a2 2 0 002 2h12a2 2 0 002-2V9zM4 13a1 1 0 011-1h1a1 1 0 110 2H5a1 1 0 01-1-1zm5-1a1 1 0 100 2h1a1 1 0 100-2H9z" clipRule="evenodd" /></svg>}
        iconBg="bg-[#00A651]/15"
      ...
      <Section
        icon={<svg className="h-3.5 w-3.5 text-[#E63946]" fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" d="M5 2a2 2 0 00-2 2v14l3.5-2 3.5 2 3.5-2 3.5 2V4a2 2 0 00-2-2H5zm4.707 3.707a1 1 0 00-1.414-1.414l-3 3a1 1 0 000 1.414l3 3a1 1 0 001.414-1.414L8.414 9H10a3 3 0 013 3v1a1 1 0 102 0v-1a5 5 0 00-5-5H8.414l1.293-1.293z" clipRule="evenodd" /></svg>}
      ...
      <div className="space-y-3 pt-2">
        <button
          ...
          disabled={!certify}
          className="flex w-full items-center justify-center gap-2 rounded-full bg-[#00A651] px-6 py-4 text-base font-bold text-white transition-all hover:bg-[#008C44] active:scale-[0.98] disabled:opacity-40"
        >
