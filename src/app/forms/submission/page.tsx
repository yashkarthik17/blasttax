...
export default function SubmissionPage() {
    ...
    return (
      <div style={{
        ...
        <div style={{ position: 'relative', width: '100%', height: 0 }}>
          {[
            { color: '#1A1A2E', size: 8, br: '50%', left: '15%', top: 0 },
            ...
            { color: '#1A1A2E', size: 6, br: '50%', left: '40%', top: -10 },
        ...
        <div style={{ textAlign: 'center', marginBottom: 6 }}>
          <div style={{ fontSize: '1.5rem', fontWeight: 900, color: '#1A1A2E', letterSpacing: '-0.02em', lineHeight: 1.2 }}>Submission Complete!</div>
        </div>
        <div style={{ textAlign: 'center', marginBottom: 24 }}>
          <div style={{ fontSize: '0.88rem', color: '#5C5C7A', fontWeight: 500, lineHeight: 1.5 }}>Your Form 656 has been submitted to the IRS</div>
        </div>

        {/* Summary Card */}
        <div style={{ width: '100%', background: 'white', borderRadius: 20, padding: 20, border: '1px solid #E8E8F0', boxShadow: '0 1px 2px rgba(0,0,0,0.03)', marginBottom: 20 }}>
          {[
            ...
            <div
              ...
              style={{
                ...
                borderBottom: idx < arr.length - 1 ? '1px solid #F0F0F5' : 'none',
            ...
            >
              ...
              <span style={{
                ...
                color: row.highlight ? '#00A651' : '#1A1A2E',
              }}>{row.value}</span>
            </div>
          ))}
        </div>
        ...
        <div style={{ width: '100%', marginBottom: 16 }}>
          <div style={{ fontSize: '0.75rem', fontWeight: 700, color: '#B0B0C8', textTransform: 'uppercase', letterSpacing: '0.06em', marginBottom: 12, padding: '0 4px' }}>What happens next?</div>
          <div style={{ background: 'white', borderRadius: 16, border: '1px solid #E8E8F0', overflow: 'hidden', boxShadow: '0 1px 2px rgba(0,0,0,0.03)' }}>
            {[
              ...
              <div key={idx} style={{
                ...
                borderBottom: idx < 2 ? '1px solid #F0F0F5' : 'none',
              }}>
                <div style={{
                  width: 28, height: 28, borderRadius: '50%', background: '#EBF0FF',
                  display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0, marginTop: 1,
                }}>
                  <span style={{ fontSize: '0.72rem', fontWeight: 800, color: '#1A1A2E' }}>{step.num}</span>
                </div>
                <div>
        ...
        <div style={{ width: '100%', display: 'flex', flexDirection: 'column', gap: 12 }}>
          ...
          <button
            style={{
              padding: 12, textAlign: 'center', color: '#1A1A2E', fontSize: '0.82rem', fontWeight: 600,
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 18, paddingTop: 8, paddingBottom: 20 }}>
      <div>
        <h1 style={{ fontSize: '1.25rem', fontWeight: 800, color: '#1A1A2E', letterSpacing: '-0.01em', lineHeight: 1.3, margin: 0 }}>Submission Review</h1>
        <p style={{ fontSize: '0.82rem', color: '#8585A0', marginTop: 6, lineHeight: 1.5, margin: '6px 0 0 0' }}>Review everything before submitting.</p>
      </div>
